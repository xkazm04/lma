...
export const CalendarPage = memo(function CalendarPage() {
  ...
  const calendarState = useCalendarViewState({ events: filteredEvents });
    ...
    <div className="space-y-6 animate-in fade-in">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-500">View all compliance deadlines and events</p>
        </div>
      </div>
        ...
        <div className="flex items-center gap-4 text-sm">
          ...
          {[
            ...
            <div key={label} className="flex items-center gap-1">
              <div className={`w-3 h-3 rounded-full ${color} transition-transform hover:scale-110`} />
